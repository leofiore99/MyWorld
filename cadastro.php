	      ...
	      <div class="container">
	        ...
	        <div class="navbar-header">
	          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
				...
				<a href="index.php"><img style="width:80px; height:50px; margin-left:-80px" src="images/teste2.jpg"/></a>
				<a href="#portfolio" class="page-scroll">Meu Perfil</a>
	        </div>
			<a class="navbar-brand" href="cadastro.php" style="margin-left:370px"> Convide um amigo</a>
	        ...
	        <div class="container ">
	            <div class="row">
	                <div class="col-md-12 col-sm-12">
	                   <h1 class="text-capitalize"><strong>Convide <span class="themecolor">Agora!</span></strong></h1>
