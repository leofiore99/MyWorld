	...
	<div>
	 ...
	 ============================================================================================================================-->
      ...
      <div class="container">
		...
		<a class="navbar-brand" href="cadastroMembro.php" style="margin-left:250px">Cadastre-se</a>
	        ...
	        <div class="container ">
	            <div class="row">
	                <div class="col-md-12 col-sm-12">
	                   <h1 class="text-capitalize"><strong><span class="themecolor">Cadastro</span></strong></h1>
	               <p class="lead"><strong> Insira aqui seus dados </strong></p>
	                <br />
					<form method="POST" action="cadastrarMembro.php">
