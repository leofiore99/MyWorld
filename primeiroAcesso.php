        ...
        <div class="container ">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                   <h1 class="text-capitalize"><strong>Seja bem-vindo ao MY<span class="themecolor"> World, <?php echo $_SESSION['UsuarioNome']; ?>!</span></strong></h1>
               <p class="lead"><strong> Por favor, atualize sua senha! </strong></p>
                <br />
                        ...
                        <div class="row" style="margin-left: 395px">
                            <div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" disabled="disabled" id="email" value="<?php echo $_SESSION['UsuarioEmail']; ?>">
                                </div>
                                <div class="form-group">
                                    <label style="font-size:20px" for="novaSenha">Nova senha:</label>
                                    <input type="password" class="form-control" name="novaSenha" id="novaSenha" placeholder="Digite a nova senha">
                                </div>
								<div class="form-group">
                                    <label style="font-size:20px" for="confirmaSenha">Confirmar nova senha:</label>
                                    <input type="password" class="form-control" name="confirmaSenha" id="confirmaSenha" placeholder="Confirme a nova senha">
                                </div>
                            </div>
                            <div class="col-md-6">
